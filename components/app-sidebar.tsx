...
const navigationItems = [
  ...
  { title: "Review", icon: Eye, page: "timeline", color: "text-green-400" },
  { title: "Analyze", icon: BarChart3, page: "analyze", color: "text-orange-400" },
  ...
  { title: "Leaderboard", icon: Trophy, page: "leaderboard", color: "text-yellow-400" },
  { title: "Challenges", icon: Zap, page: "challenges", color: "text-red-400" },
  { title: "Achievements", icon: Trophy, page: "achievements", color: "text-purple-400" },
  { title: "Friends", icon: Users, page: "friends", color: "text-indigo-400" },
]
      ...
      <SidebarHeader className="p-4">
        <div className="flex items-center gap-3 group">
          <Avatar className="h-10 w-10 ring-2 ring-purple-500 ring-offset-2 ring-offset-white dark:ring-offset-slate-900 transition-all duration-300 group-hover:ring-4">
            <AvatarImage src="/placeholder.svg?height=40&width=40&text=K" alt="Kairu" />
            <AvatarFallback className="bg-gradient-to-br from-purple-500 to-pink-500 text-white font-bold">
              K
            </AvatarFallback>
          </Avatar>
          <div className="transition-transform duration-300 group-hover:translate-x-1">
            <p className="text-sm font-bold text-slate-900 dark:text-white">Kairu</p>
            <p className="text-xs text-slate-500 dark:text-slate-400">Stay focused, achieve more.</p>
          </div>
        </div>
      </SidebarHeader>
            ...
            <SidebarMenuItem key={item.title}>
              ...
              >
                ...
                {item.title === "Challenges" && (
                  <Badge className="ml-auto bg-gradient-to-r from-red-500 to-orange-500 text-white text-xs animate-pulse shadow-lg">
                    21
                  </Badge>
                )}
              </SidebarMenuButton>
